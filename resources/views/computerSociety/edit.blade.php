...
<body>
    ...
    <div class="container m-4">
        ...
        <form action="{{ route('computerexecom.editsave') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <h1 class="mb-5">Add New CS execom</h1>
    ...
    <!-- <a href="{{route('computerexecom.editsave')}}">test</a> -->
</body>
